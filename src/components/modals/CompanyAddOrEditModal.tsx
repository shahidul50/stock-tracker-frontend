...
export function CompanyAddOrEditModal({
  isOpen,
  onClose,
  onSubmit,
  initialValues,
        ...
        <DialogHeader className="p-6 pb-2">
          ...
          {isEdit && (
            <DialogDescription className="text-xs text-muted-foreground sm:text-sm mt-1">
             Update the details for the selected company or supplier.
            </DialogDescription>
          )}
        </DialogHeader>
                  ...
                  <Field data-invalid={isInvalid}>
                    ...
                    <InputGroup>
                      <InputGroupTextarea
                        ...
                        onBlur={field.handleBlur}
                        onChange={(e) => field.handleChange(e.target.value)}
                        placeholder="Email, phone number, address, or any relevent details..."
                        rows={4}
